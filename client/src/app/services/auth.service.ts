...
export class AuthService {
  ...
  login(username: string, password: string): Observable<any> {
    return this.http
      .post('http://localhost:5163/api/Account/Login', { username, password })
      .pipe(
        tap<any>(
          (response) => {
  ...
  // ): Observable<any> {
  //   return this.http
  //     .post('http://localhost:5163/api/Account/Register/User', {
  //       username,
  //       EmailAddress,
  //       password,
  //     })
  ...
  // ): Observable<any> {
  //   return this.http
  //     .post('http://localhost:5163/api/Account/Register/admin', {
  //       username,
  //       EmailAddress,
  //       password,
  //     })
