    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CandidatureUrgents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Abscences_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conges_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Heuresupplimentaires", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Heuresupplimentaires_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Paiements_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Candidatures_AnnonceId",
                table: "Candidatures",
                column: "AnnonceId");

            migrationBuilder.CreateIndex(
                name: "IX_Conges_AppUserId",
                table: "Conges",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Heuresupplimentaires_AppUserId",
                table: "Heuresupplimentaires",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Paiements_AppUserId",
                table: "Paiements",
                column: "AppUserId");
        }
